...
xform <- list(categoryorder = "array",
              categoryarray = c("Baby Got Track", "Gator Dad", "Don't Beat My Johnson", "Up Front", "Killer B's", "Chasing Cletus", "Hollywood High Life", "J-Town Throw Down", "Ricky Bobby", "Redneck Ghoster", "Field" ))
...
<div class="container">
<h1 class="header center">Next Stop: Michigan International Speedway</h1>
<div class="row center">
<div class="card">
<div class="card-image">
<img src="../../public/images/michiganintlspeedway.jpg">
</div>
<div class="card-content"
<h5 class="header col s12 light">Michigan International Speedway this Sunday, August 12th @ 1430 ET on NBCSN</h5>
</div>  
</div>
</div>
<br>
