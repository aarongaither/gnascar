...
xform <- list(categoryorder = "array",
              categoryarray = c("Baby Got Track", "Chasing Cletus", "Gator Dad",  "Don't Beat My Johnson", "Up Front", "Killer B's", "J-Town Throw Down", "Hollywood High Life", "Ricky Bobby",  "Redneck Ghoster", "Field" ))
...
<div class="container">
<h1 class="header center">Homestead!!!!!!!</h1>
<div class="row center">
<div class="card">
<div class="card-image">
<img src="../../public/images/homestead.jpg">
</div>
<div class="card-content"
<h5 class="header col s12 light">Miami Championship Race | November 18th @1500 ET on NBC</h5>
</div>  
</div>
</div>
<br>
