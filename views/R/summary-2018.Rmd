...
xform <- list(categoryorder = "array",
              categoryarray = c("Baby Got Track", "Gator Dad", "Don't Beat My Johnson", "Chasing Cletus", "Up Front", "J-Town Throw Down", "Hollywood High Life", "Killer B's", "Ricky Bobby", "Redneck Ghoster", "Field" ))
...
<div class="container">
<h1 class="header center">First Playoff Race: Las Vegas Motor Speedway</h1>
<div class="row center">
<div class="card">
<div class="card-image">
<img src="../../public/images/LasVegas_Motor_Speedway.jpg">
</div>
<div class="card-content"
<h5 class="header col s12 light">Las Vegas Motor Speedway | September 16th @ 1500 ET on NBCSN</h5>
</div>  
</div>
</div>
<br>
