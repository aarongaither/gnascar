...
xform <- list(categoryorder = "array",
              categoryarray = c("Baby Got Track", "Gator Dad", "Don't Beat My Johnson", "Up Front", "Chasing Cletus", "Killer B's",  "Hollywood High Life", "J-Town Throw Down", "Ricky Bobby", "Redneck Ghoster", "Field" ))
...
<div class="container">
<h1 class="header center">Next Stop: Indianapolis Motor Speedway</h1>
<div class="row center">
<div class="card">
<div class="card-image">
<img src="../../public/images/indymotorspeedway.jpg">
</div>
<div class="card-content"
<h5 class="header col s12 light">Indianapolis Motor Speedway | September 9th @ 1400 ET on NBCSN</h5>
</div>  
</div>
</div>
<br>
