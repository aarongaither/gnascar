...
xform <- list(categoryorder = "array",
              categoryarray = c("Baby Got Track", "Gator Dad", "Chasing Cletus", "Don't Beat My Johnson", "Up Front", "J-Town Throw Down", "Killer B's", "Ricky Bobby", "Hollywood High Life", "Redneck Ghoster", "Field" ))
...
p_team <- plot_ly(seasonstandings2018, x = ~Team, y = ~Points, type = 'bar', text=~Driver, 
    ...
    layout(yaxis = list(title = 'Points', dtick = 250), xaxis = list(title = ' '), barmode = 'stack') %>%
  layout(xaxis = xform)
...
<div class="container">
<h1 class="header center">First Race of the Second Playoff Round</h1>
<div class="row center">
<div class="card">
<div class="card-image">
<img src="../../public/images/doverspeedway.jpg">
</div>
<div class="card-content"
<h5 class="header col s12 light">Dover International Speedway | October 7th @ 1400 ET on NBCSN</h5>
</div>  
</div>
</div>
<br>
