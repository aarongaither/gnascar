...
xform <- list(categoryorder = "array",
              categoryarray = c("Baby Got Track", "Gator Dad", "Don't Beat My Johnson", "Chasing Cletus", "Up Front", "Killer B's",  "Hollywood High Life", "J-Town Throw Down", "Ricky Bobby", "Redneck Ghoster", "Field" ))
...
<div class="container">
<h1 class="header center">Next Stop: Darlington Raceway</h1>
<div class="row center">
<div class="card">
<div class="card-image">
<img src="../../public/images/darlington_raceway.jpg">
</div>
<div class="card-content"
<h5 class="header col s12 light">Darlington Raceway September 2nd @ 1800 ET on NBCSN</h5>
</div>  
</div>
</div>
<br>
