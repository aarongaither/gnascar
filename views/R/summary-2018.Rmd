...
xform <- list(categoryorder = "array",
              categoryarray = c("Baby Got Track", "Gator Dad", "Don't Beat My Johnson", "Killer B's", "Up Front", "Chasing Cletus", "Hollywood High Life", "J-Town Throw Down", "Ricky Bobby", "Field", "Redneck Ghoster"))
...
<div class="container">
<h1 class="header center">Next Stop: Chicagoland Speedway</h1>
<div class="row center">
<div class="card">
<div class="card-image">
<img src="../../public/images/chicagoland.jpg">
</div>
<div class="card-content"
<h5 class="header col s12 light">"Overton's 400 on Sunday, July 1st @ 1430 on NBCSN"</h5>
</div>  
</div>
</div>
<br>
