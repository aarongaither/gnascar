...
xform <- list(categoryorder = "array",
              categoryarray = c("Baby Got Track", "Gator Dad", "Don't Beat My Johnson", "Up Front", "Killer B's", "Chasing Cletus", "Hollywood High Life", "J-Town Throw Down", "Ricky Bobby", "Field", "Redneck Ghoster"))
...
<div class="container">
<h1 class="header center">Next Stop: Kentucky Speedway</h1>
<div class="row center">
<div class="card">
<div class="card-image">
<img src="../../public/images/kentuckyspeedway.jpg">
</div>
<div class="card-content"
<h5 class="header col s12 light">Kentucky Speedway this Saturday, July 14th @ 1930 ET on NBCSN</h5>
</div>  
</div>
</div>
<br>
